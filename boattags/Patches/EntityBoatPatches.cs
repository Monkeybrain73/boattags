...
namespace boattags.Patches
{
    ...
    /// point for saw-based deconstruction. Blocks non-owners from deconstructing tagged boats.
    ...
    /// </summary>
    [HarmonyPatch(typeof(CollectibleBehaviorEntityDeconstructTool), "OnHeldInteractStart")]
